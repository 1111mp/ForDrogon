...
/**
 *
 *  RestfulFriendSettingsCtrlBase.cc
...
void RestfulFriendSettingsCtrlBase::getOne(const HttpRequestPtr &req,
                                           ...
                                           FriendSettings::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<FriendSettings> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](FriendSettings r) {
...
void RestfulFriendSettingsCtrlBase::updateOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              FriendSettings::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!FriendSettings::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!FriendSettings::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulFriendSettingsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              FriendSettings::PrimaryKeyType &&id)
{
...
void RestfulFriendSettingsCtrlBase::get(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<FriendSettings> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<FriendSettings> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<FriendSettings> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulFriendSettingsCtrlBase::create(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!FriendSettings::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!FriendSettings::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        FriendSettings object = 
            (isMasquerading()? 
             FriendSettings(*jsonPtr, masqueradingVector()) : 
             FriendSettings(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](FriendSettings newObject){
...
/*
void RestfulFriendSettingsCtrlBase::update(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulFriendSettingsCtrlBase::RestfulFriendSettingsCtrlBase()
    : RestfulController({
          "id",
          "user_id",
          "friend_id",
      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "astrolabe", // the alias for the astrolabe column.
        "block", // the alias for the block column.
